...
import {
  ...
  DATE_TIME_FORMAT_FULL_DATE,
  DATE_TIME_FORMAT_LONG,
  DATE_TIME_FORMAT_LONG_DATE,
  DATE_TIME_FORMAT_LONG_TIME,
  DATE_TIME_FORMAT_MEDIUM,
  DATE_TIME_FORMAT_MEDIUM_DATE,
  DATE_TIME_FORMAT_MEDIUM_TIME,
  DATE_TIME_FORMAT_MINIMAL,
  DATE_TIME_FORMAT_MINIMAL_DATE,
...
/**
 * Shortcuts from a common date format (string) to the options to provide to Intl.DateTimeFormat
 */
